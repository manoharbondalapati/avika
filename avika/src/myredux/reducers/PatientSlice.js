...
export const { fetchDetailsSuccess, fetchDetailsFailure } = PatientSlice.actions;
...
export const fetchRecordById = (recordId) => async (dispatch) => {
    try {
        ...
        const response = await axios.get(`https://med.test.avika.ai/admin/getMedicalRecord/${recordId}`, { headers });
