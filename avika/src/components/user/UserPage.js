...
import { updateUserData, uploadFileSuccess, uploadFileFailure } from '../../myredux/reducers/UserSlice'; // Import the actions
import axios from 'axios';
...
const UserPage = () => {
  ...
  const handleFileChange = (e) => {
    ...
    if (file && file.type === 'application/pdf') {
      dispatch(updateUserData({ ...userData, file_path: file.name })); // Store only the file name
    } else {
      // Display an error message or handle the invalid file format
