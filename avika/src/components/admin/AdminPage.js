...
//               {genderFilter
//                 ? `Number of ${genderFilter.toLowerCase()} records: ${filterRecords.length}`
...
//   }, [searchQuery, genderFilter, records]);
...
//             <p className="ml-2 length">
//               {genderFilter
//                 ? `Number of ${genderFilter.toLowerCase()} records: ${filteredRecords.length}`
//                 : `All Documents: ${records?.length}`}
//             </p>
//           </div>
//         </div>
